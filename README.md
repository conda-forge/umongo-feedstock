...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13919&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/umongo-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `umongo` can be installed with `conda`:
...
```
mamba install umongo
```

It is possible to list all of the versions of `umongo` available on your platform with `conda`:
...
```
mamba search umongo --channel conda-forge
```
...
mamba repoquery search umongo --channel conda-forge

# List packages depending on `umongo`:
mamba repoquery whoneeds umongo --channel conda-forge

# List dependencies of `umongo`:
mamba repoquery depends umongo --channel conda-forge
```
